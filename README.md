...
<p align="center">
  <img src="pics/demo1.png" alt="HealthDesk Agent 桌宠输出办公健康建议" width="360">
  <img src="pics/demo2.png" alt="点击桌宠后出现爱心特效并唤起对话" width="360">
</p>

桌宠名叫“小灵”。你可以点击它、拖动它、和它聊天。它会根据 Agent 的最终结构化输出显示办公健康建议；点击时会切换形象并出现小爱心。桌面版不局限在浏览器里，可以在 Windows 桌面和副屏之间自由拖动并驻留。
...
- 桌宠展示：支持完整 Web dashboard、浏览器轻量桌宠、真实 Windows 桌面桌宠三种模式。
...
本项目仍在持续迭代中。如果你也关心“AI 如何更自然地照顾普通人的日常健康”，欢迎 fork、试跑和改造。
