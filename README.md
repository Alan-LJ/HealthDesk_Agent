...
桌宠名叫“小灵”。你可以点击它、拖动它、和它聊天。它会根据 Agent 的最终结构化输出显示办公健康建议；点击时会切换形象并出现小爱心。最新版本支持小/中/大/超大四档大小切换，超大档按“大”档总面积的 4 倍等比例放大；浏览器轻量桌宠可在对话框中直接选择大小，Windows 桌面版可通过右键菜单调整大小。桌面版不局限在浏览器里，可以在 Windows 桌面和副屏之间自由拖动并驻留。
